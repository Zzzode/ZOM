...
```text
tests/unittests/compiler/<component>/<name>-test.cc
```
...
```text
tests/conformance/corpus/<chapter>/<feature>.zom
```

Add the matching expectation file at the same relative path:

```text
tests/conformance/expectations/ast/<chapter>/<feature>.check
```
...
bash tests/conformance/runners/grammar/run_tests.sh 04-expressions
```
