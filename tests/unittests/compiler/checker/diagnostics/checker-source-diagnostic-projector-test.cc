...
ZC_TEST("CheckerSourceDiagnosticProjector.RendersEveryStructuredDisplayVariant") {
...
ZC_TEST("CheckerSourceDiagnosticProjector.RendersCanonicalScalarValues") {
  RendererFixture fixture;
...
ZC_TEST("CheckerSourceDiagnosticProjector.RendersAggregateCanonicalValues") {
  RendererFixture fixture;
...
ZC_TEST("CheckerSourceDiagnosticProjector.RendersEveryPrimitiveSpelling") {
  RendererFixture fixture;
...
ZC_TEST("CheckerSourceDiagnosticProjector.RendersEveryConstraintReason") {
  RendererFixture fixture;
...
ZC_TEST("CheckerSourceDiagnosticProjector.RendersEveryStructuredSemanticType") {
  RendererFixture fixture;
  const auto i32 = fixture.renderIntern(type::semantic::TypeData(
      type::semantic::PrimitiveTypeData{type::semantic::PrimitiveKind::I32}));
  const auto str = fixture.renderIntern(type::semantic::TypeData(
...
ZC_TEST("CheckerSourceDiagnosticProjector.EscapesAndTruncatesSourceHints") {
  RendererFixture fixture;
