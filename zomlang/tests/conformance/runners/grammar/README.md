...
bash zomlang/tests/conformance/runners/grammar/run_tests.sh

# Run only directories whose name matches a substring
bash zomlang/tests/conformance/runners/grammar/run_tests.sh 02-lexical
bash zomlang/tests/conformance/runners/grammar/run_tests.sh expressions
bash zomlang/tests/conformance/runners/grammar/run_tests.sh concurrent

# Run every REJECT test anywhere in the tree
# (file path or content contains "neg" or the canonical "_neg_" segment)
bash zomlang/tests/conformance/runners/grammar/run_tests.sh negative
```
