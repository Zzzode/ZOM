...
```text
zomlang/tests/unittests/compiler/<component>/<name>-test.cc
```
...
```text
zomlang/tests/conformance/corpus/<chapter>/<feature>.zom
```

Add the matching expectation file at the same relative path:

```text
zomlang/tests/conformance/expectations/ast/<chapter>/<feature>.check
```
...
bash zomlang/tests/conformance/runners/grammar/run_tests.sh 04-expressions
```
