...
SCHEMA_PATH = ROOT / "compiler/query/query-descriptor-schema.def"
COMPILER_ROOT = ROOT / "compiler"
QUERY_TYPES = ROOT / "compiler/query/query-types.h"
QUERY_DATABASE_HEADER = ROOT / "compiler/query/query-database.h"
QUERY_DATABASE_IMPLEMENTATION = ROOT / "compiler/query/query-database.cc"
QUERY_TEST_SPECS = (
    ROOT
...
STABLE_BINDING_SCHEMA = (
    ROOT / "compiler/binder/stable-binding-schema.def"
)
TEST_CMAKE = ROOT / "tests/CMakeLists.txt"
NEGATIVE_FIXTURE = (
    ROOT / "tests/cmake/expect-compile-failure/CMakeLists.txt"
)
NEGATIVE_DIRECTORY = (
    ROOT / "tests/compile-fail/query-runtime"
)
NEGATIVE_CASES = {
...
def check_provenance_owned_aliases(
    ...
    schema_path = "compiler/binder/stable-binding-schema.def"
    relevant_macros = (
...
def run_self_test() -> None:
    fixture_path = ROOT / "compiler/example/query-fixture.h"
    rows = GENERATOR.parse_schema_text(
        "\n".join(
            [
                ...
                '"compiler/example/query-fixture")',
                ...
                '"compiler/driver/module-graph-query-input")',
    ...
    schema_include = '#include "compiler/binder/stable-binding-schema.def"\n'
    cleanup_directives = (
    ...
    escaped_access[
        ROOT / "compiler/example/escaped.cc"
