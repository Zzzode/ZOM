...
PRODUCTION_SCHEMA = (
    ROOT / "compiler/query/query-descriptor-schema.def"
)
TEST_SCHEMA = (
    ROOT
...
TEST_RELATIVE_OUTPUT = Path(
    "tests/unittests/compiler/query/"
...
COMPLETE_CONTEXT_OWNER = "compiler/driver/query/module-graph/module-graph-query-input"
TRANSACTION_WITNESS_OWNER = (
    "compiler/driver/query/module-graph/module-graph-query-input"
)
...
TEST_COMPLETE_CONTEXT_OWNER = (
    "tests/unittests/compiler/query/query-test-specs"
)
