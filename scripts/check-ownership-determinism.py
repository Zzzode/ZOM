...
CORPUS = ROOT / "products/zomlang/tests/conformance/corpus"
PACKAGE_RUNNER = ROOT / "products/zomlang/tests/tools/run-zomc-package.py"
BASELINE = ROOT / "products/zomlang/tests/coverage/ownership-determinism-baseline.json"
