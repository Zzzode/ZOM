...
LEXER_DIR = ROOT / "compiler" / "lexer"
PARSER_DIR = ROOT / "compiler" / "parser"
LEXER_TEST_DIR = ROOT / "tests" / "unittests" / "compiler" / "lexer"
CONFORMANCE_CORPUS = ROOT / "tests" / "conformance" / "corpus"
CONFORMANCE_GRAMMAR = (
    ROOT / "tests" / "conformance" / "expectations" / "grammar"
)
CONFORMANCE_AST = (
    ROOT / "tests" / "conformance" / "expectations" / "ast"
)
DESIGN_DIR = ROOT / "docs" / "design"
LEXICAL_SPEC = ROOT / "docs" / "spec" / "chapters" / "02-lexical-structure.md"
ZOM_LEXER_G4 = ROOT / "docs" / "spec" / "ZomLexer.g4"
KINDS_H = ROOT / "compiler" / "ast" / "kinds.h"
