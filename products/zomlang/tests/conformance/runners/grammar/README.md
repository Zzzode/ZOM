...
| 2 | `03-types` | Type syntax: primitives, function types, tuples, unions, references, type aliases | 34 | 15 | 27 | 0 | 76 |
| 3 | `04-expressions` | Operators, precedence, calls, casts, lambdas, spawn, control-flow expressions | 45 | 26 | 44 | 8 | 123 |
...
| 10 | `12-generics` | Generic parameters, where clauses, generic instantiation, variance placeholders | 14 | 6 | 12 | 0 | 32 |
...
Recursive count of grammar expectation files: **659**
