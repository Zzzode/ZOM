...
| 3 | `04-expressions` | Operators, precedence, calls, casts, lambdas, spawn, control-flow expressions | 39 | 26 | 42 | 8 | 115 |
...
| 10 | `12-generics` | Generic parameters, where clauses, generic instantiation, variance placeholders | 13 | 6 | 9 | 0 | 28 |
...
Recursive count of grammar expectation files: **641**
