...
ALLOWED_AST_WITHOUT_GRAMMAR_CHECKS = {
    ...
    Path("06-declarations/functions/closure-function-definitions/captures.check"),
    Path("06-declarations/functions/closure-function-definitions/closure.check"),
    Path("06-declarations/functions/closure-function-definitions/generic.check"),
    Path("06-declarations/functions/closure-function-definitions/raises.check"),
