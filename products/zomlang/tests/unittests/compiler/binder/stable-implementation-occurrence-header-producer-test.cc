...
StableImplementationOccurrenceHeader produce(const HeaderFixture& fixture, size_t ordinal) {
  ...
  return require(StableImplementationOccurrenceHeaderProducer::produce(
      StableImplementationOccurrenceHeaderProductionInput{fixture.parsed(), query, entry, site,
...
ZC_TEST("StableImplementationOccurrenceHeaderProducer covers source forms scopes and generics") {
...
ZC_TEST("StableImplementationOccurrenceHeaderProducer rejects one-field input mutations") {
  HeaderFixture fixture(tests::test_identity_detail::source());
  ...
  ZC_EXPECT(StableImplementationOccurrenceHeaderProducer::produce(
  ...
  ZC_EXPECT(StableImplementationOccurrenceHeaderProducer::produce(
                StableImplementationOccurrenceHeaderProductionInput{fixture.parsed(), query, entry,
