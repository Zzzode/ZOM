...
OverloadHeaderDigest OverloadHeaderDigest::compute(const CanonicalOverloadHeader& header) {
...
OverloadHeaderAuthority OverloadHeaderAuthority::from(CanonicalOverloadHeader&& header) {
...
const CanonicalOverloadHeader& OverloadHeaderAuthority::header() const noexcept {
  return impl->header;
}
