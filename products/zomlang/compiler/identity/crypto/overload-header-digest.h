...
public:
  ...
  ZC_NODISCARD static OverloadHeaderDigest compute(const OverloadHeader& header);
...
public:
  ...
  ZC_NODISCARD static OverloadHeaderAuthority from(OverloadHeader&& header);
  ZC_NODISCARD OverloadHeaderAuthority clone() const;
  ZC_NODISCARD const OverloadHeaderDigest& digest() const noexcept;
  ZC_NODISCARD const OverloadHeader& header() const noexcept;
