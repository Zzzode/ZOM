...
public:
  ~CanonicalOverloadHeader() noexcept(false);
  CanonicalOverloadHeader(CanonicalOverloadHeader&&) noexcept;
  CanonicalOverloadHeader& operator=(CanonicalOverloadHeader&&) noexcept;
  ZC_DISALLOW_COPY(CanonicalOverloadHeader);
  ...
  ZC_NODISCARD static zc::Maybe<CanonicalOverloadHeader> from(
  ...
  ZC_NODISCARD CanonicalOverloadHeader clone() const;
...
private:
  explicit CanonicalOverloadHeader(
