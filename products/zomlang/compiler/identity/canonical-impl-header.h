...
public:
  ~CanonicalImplHeader() noexcept(false);
  CanonicalImplHeader(CanonicalImplHeader&&) noexcept;
  CanonicalImplHeader& operator=(CanonicalImplHeader&&) noexcept;
  ZC_DISALLOW_COPY(CanonicalImplHeader);
  ...
  ZC_NODISCARD static zc::Maybe<CanonicalImplHeader> from(
