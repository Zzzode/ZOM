...
Evidence: `products/zomlang/compiler/checker/trait-resolver.cc:199`, the former
...
Evidence: `products/zomlang/compiler/type/named-type.cc:75`,
`products/zomlang/compiler/type/type-interner.cc:166`,
`products/zomlang/compiler/type/type-env.cc:1014`, and
`products/zomlang/compiler/checker/trait-resolver.cc:1501`.
...
Evidence: `products/zomlang/compiler/type/type-env.cc:110`,
`products/zomlang/compiler/type/type-env.cc:172`, and
`products/zomlang/compiler/type/type-env.cc:220`.
