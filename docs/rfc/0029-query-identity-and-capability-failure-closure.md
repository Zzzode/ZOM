...
| Canonical Module and Binder diagnostic facts | `products/zomlang/compiler/binder/stable-binding-diagnostic-fact.h`; `products/zomlang/compiler/binder/stable-binding-diagnostic-fact.cc`; `products/zomlang/compiler/diagnostics/fact/diagnostic-fact.h`; `products/zomlang/compiler/diagnostics/fact/diagnostic-fact.cc` |
