...
| Concern | Exact files |
|---|---|
| Site inventory and admission payloads | `products/zomlang/compiler/binder/identity/identity-pre-admission.h`; `products/zomlang/compiler/binder/identity/identity-pre-admission.cc` |
| Stable-admission Binder boundary | `products/zomlang/compiler/binder/surface/module-body-syntax.h`; `products/zomlang/compiler/binder/surface/module-body-syntax-producer.cc`; `products/zomlang/compiler/binder/surface/module-body-syntax-verifier.cc` |
...
| Canonical Module and Binder diagnostic facts | `products/zomlang/compiler/binder/stable/stable-binding-diagnostic-fact.h`; `products/zomlang/compiler/binder/stable/stable-binding-diagnostic-fact.cc`; `products/zomlang/compiler/diagnostics/fact/diagnostic-fact.h`; `products/zomlang/compiler/diagnostics/fact/diagnostic-fact.cc` |
| Diagnostic codes, schema rows, and static mappings | `products/zomlang/compiler/diagnostics/defs/diagnostics-binder.def`; `products/zomlang/compiler/binder/stable-binding-schema.def`; `scripts/check-stable-binding-schema.py`; `scripts/check-binder-architecture.py`; `scripts/check-diagnostic-coverage.py` |
| Descriptors, failure contracts, and caller cutover | `products/zomlang/compiler/driver/query/binding/named-identity-inventory-query.h`; `products/zomlang/compiler/driver/query/binding/named-identity-inventory-query.cc`; `products/zomlang/compiler/driver/query/binding/named-item-query.h`; `products/zomlang/compiler/driver/query/binding/named-item-query.cc`; `products/zomlang/compiler/driver/query/binding/owner-body-query.h`; `products/zomlang/compiler/driver/query/binding/owner-body-query.cc` |
