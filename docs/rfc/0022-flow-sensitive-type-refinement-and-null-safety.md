...
```text
ASCII("zom.checked-facts-revision.v4")
0x00
...
is the flow-refinement record. Its complete 663-byte preimage is:

```text

```

Its SHA-256 is
`7c07eec3e2b4152feef42052be203f962e6ca41af9f2ff95dc311a7b7e102660`.
...
`v3` decoder or compatibility path is retained.
...
This is a direct semantic and checked-facts replacement. There is no feature
flag, compatibility mode, dual fact representation, or decoder for earlier
checked-facts cache entries.
...
- The solver terminates within the finite `BodyFlowTypeBasis` closure and
  ...
  operations.
- The checked-facts `v4` framing oracle and per-group mutation oracles pass.
