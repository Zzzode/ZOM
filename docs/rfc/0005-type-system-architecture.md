...
| 2026-07-09 | REVIEW | Removed obsolete checker compatibility paths that interpreted reference and raw-pointer type expressions from unary-expression test encodings; declaration signatures and trait-resolution field checks now rely on the dedicated AST schema nodes. |
