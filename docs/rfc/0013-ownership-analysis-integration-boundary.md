...
| Reference, storage, extern, and ABI safety boundary | `docs/spec/chapters/14-memory-management.md`, `products/zomlang/runtime/**` | `runtime-memory` |
| Type, module, memory, and compiler-contract alignment | `docs/spec/**`, `docs/design/**` | `spec-audit` |
| Codec, diagnostics, architecture, and conformance gates | `products/zomlang/tests/**`, `scripts/**` | `verification` |
