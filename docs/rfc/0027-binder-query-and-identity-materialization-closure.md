...
| `L4` | `runtime-memory` | `L3` | `compiler/ownership/overlay/ownership-event-overlay.h`; `compiler/ownership/overlay/ownership-event-overlay.cc` | ownership-overlay retained lease, verifier, and destruction order |
