...
| `M1C1` | `module-system` | `M1B` review | `products/zomlang/compiler/driver/materialized-module-graph-query.cc` | prepare provider-only canonical ordered input acquisition and exact typed child-failure forwarding through provenance reads; do not materialize or land independently |
