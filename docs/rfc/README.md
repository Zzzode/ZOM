...
| [RFC 0049](0049-enum-variants-and-exhaustive-matching.md) | Enum Variants And Exhaustive Matching | ACCEPTED | language | language | rfc | [Review Tracker](tracking/0049-enum-variants-and-exhaustive-matching-review.md) | TBD |
