...
| [RFC 0016](0016-context-bound-target-registry-verification.md) | Context-Bound Target Registry Verification | REVIEW | compiler | compiler | rfc | [Review Tracker](tracking/0016-review-and-implementation.md) | TBD |
...
| [RFC 0029](0029-query-identity-and-capability-failure-closure.md) | Query Identity And Capability Failure Closure | IMPLEMENTING | compiler | compiler | rfc | [Review Tracker](tracking/0029-review-and-implementation.md) | [Implementation Tracker](tracking/0029-review-and-implementation.md#implementation-tracker) |
