...
| [RFC 0007](0007-borrow-lifetime-ownership-checker.md) | Borrow Lifetime And Ownership Checker | ACCEPTED | compiler | compiler | rfc | [Review Tracker](tracking/0007-review-and-implementation.md) | TBD |
...
| [RFC 0015](0015-canonical-checker-codec-closure.md) | Canonical Checker Codec Closure | IMPLEMENTING | language | language | rfc | [Review Tracker](tracking/0015-review-and-implementation.md) | [Implementation Tracker](tracking/0015-review-and-implementation.md#implementation-tracker) |
| [RFC 0016](0016-context-bound-target-registry-verification.md) | Context-Bound Target Registry Verification | DRAFT | compiler | compiler | rfc | [Review Tracker](tracking/0016-review-and-implementation.md) | TBD |
