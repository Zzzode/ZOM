...
| [RFC 0002](0002-parser-architecture.md) | Parser Architecture | REVIEW | compiler | compiler | rfc | [Acceptance Criteria](0002-parser-architecture.md#acceptance-criteria) | TBD |
