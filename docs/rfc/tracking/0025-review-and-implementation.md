...
The live audit found a source-backed seed under `core`, containing
...
`zomlang/compiler/identity/key/compilation-unit-key.h`, and
`zomlang/compiler/identity/key/compilation-unit-key.cc`. The dedicated
...
`zomlang/tests/fixtures/package-oracles/package-generated-oracles.json`.
...
|---|---|---|---|---|---|---|
| `R25-00` | `task-router` | `AGENTS.md`<br>`.codex/subagents/README.md`<br>`.codex/subagents/manifest.yaml`<br>`.codex/subagents/task-router.md`<br>`.codex/subagents/rfc.md`<br>`.codex/subagents/lexer-parser.md`<br>`.codex/subagents/binder-checker.md`<br>`.codex/subagents/module-system.md`<br>`.codex/subagents/error-system.md`<br>`.codex/subagents/concurrency.md`<br>`.codex/subagents/ir-backend.md`<br>`.codex/subagents/runtime-memory.md`<br>`.codex/subagents/tooling-lsp.md`<br>`.codex/subagents/spec-audit.md`<br>`.codex/subagents/verification.md` | None | Freeze one primary owner and every mandatory review gate for each RFC 0025 path without granting product implementation authority. | `python3 scripts/check-rfc.py`<br>`python3 scripts/check-no-internal-versioning.py --check`<br>`git diff --check` | Complete |
