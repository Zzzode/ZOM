...
| `R27-26A` | `module-system` | `R27-26` | Complete: module-interface publication owns and retains its `CheckerBoundModuleView`. | Focused interface tests | Complete; module-interface teardown retention coverage passed on 2026-08-05. |
| `R27-27A` | `ir-backend` | `R27-26` | Complete: verified checked modules retain their bound-module view. | Checked-module lineage tests | Complete; package pipeline lineage coverage passed on 2026-08-05. |
| `R27-27B` | `ir-backend` | `R27-27A` | Complete: verified HIR retains its bound-module view. | HIR lineage tests | Complete; scalar-return HIR lineage coverage passed on 2026-08-05. |
| `R27-27C` | `ir-backend` | `R27-27B` | Complete: Built MIR retains its bound-module view. | MIR lineage tests | Complete; scalar-return MIR lineage coverage passed on 2026-08-05. |
| `R27-27D` | `runtime-memory` | `R27-27C` | Complete: ownership overlays retain their bound-module view and session teardown releases them first. | Ownership lineage tests | Complete; teardown order and package pipeline coverage passed on 2026-08-05. |
