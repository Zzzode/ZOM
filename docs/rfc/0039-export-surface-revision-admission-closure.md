...
| Revision identity | `products/zomlang/compiler/binder/binding-metadata.{h,cc}` | `binder-checker` |
| Stable codec consumer | `products/zomlang/compiler/binder/stable-binding-codec.{h,cc}` | `binder-checker` |
| Native evidence | `products/zomlang/tests/unittests/compiler/binder/stable-binding-facts-test.cc` | `verification` |
