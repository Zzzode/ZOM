...
```cpp
// From docs/design/algebraic-data-types.md §6.3 — canonical design
#pragma once
...
```cpp
// From docs/design/algebraic-data-types.md §9.5 — canonical design
#pragma once
#include "zom/base/own.h"
#include "zom/base/small_vector.h"
#include <cstddef>
...
```cpp
// From docs/design/algebraic-data-types.md §10.4 — canonical design
#pragma once
#include "zom/base/own.h"
