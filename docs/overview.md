...
- [Spec](spec/specification.md)
  - [Grammar Reference](spec/chapters/17-grammar-reference.md)
...
- [runtime-ffi-examples.md](design/runtime-ffi-examples.md) — FFI runtime examples
- [ast-data-structure.md](design/ast-data-structure.md) — AST data structure
- [schema.yml](../products/zomlang/compiler/ast/schema.yml) — AST node schema
